...
define Device/glinet_gl-mt3000
  ...
  DEVICE_DTS_DIR := ../dts
  SUPPORTED_DEVICES += glinet,gl-mt3000 glinet,mt3000-snand
...
define Device/tenbay_ac-2210e
  ...
  DEVICE_DTS := mt7981-tenbay_ac-2210e
  DEVICE_DTS_DIR := ../dts
...
define Device/tenbay_ms3000k
  ...
  DEVICE_DTS := mt7981-tenbay_ms3000k
...
define Device/tenbay_wr3000k
  ...
  DEVICE_DTS := mt7981-tenbay_wr3000k
  DEVICE_DTS_DIR := ../dts
  DEVICE_PACKAGES := kmod-mt7981-firmware mt7981-wo-firmware
...
define Device/tenbay_ac-2205ex
  ...
  DEVICE_DTS := mt7981-tenbay_ac-2205ex
  DEVICE_DTS_DIR := ../dts
...
define Device/qihoo_360t7
  DEVICE_VENDOR := Qihoo
  DEVICE_MODEL := 360T7
  DEVICE_DTS := mt7981-qihoo_360t7
  DEVICE_DTS_DIR := ../dts
  DEVICE_PACKAGES := kmod-mt7981-firmware mt7981-wo-firmware
  SUPPORTED_DEVICES := qihoo,360t7 360,t7 mediatek,mt7981-spim-snand-rfb
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  IMAGE_SIZE := 65536k
